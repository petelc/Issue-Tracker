...
/* harmony import */ var _auth0_auth0_react__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @auth0/auth0-react */ "@auth0/auth0-react");
/* harmony import */ var _auth0_auth0_react__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_auth0_auth0_react__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _withToasts_jsx__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./withToasts.jsx */ "./src/withToasts.jsx");
/* harmony import */ var _Auth_LoginButton_jsx__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Auth/LoginButton.jsx */ "./src/Auth/LoginButton.jsx");
/* harmony import */ var _Auth_LogoutButton_jsx__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Auth/LogoutButton.jsx */ "./src/Auth/LogoutButton.jsx");
...
class SignInNavItem extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
    this.state = {
      showing: false // isAuthenticated: withAuth0.isAuthenticated,
      // user: withAuth0.user,
  ...
  render() {
    ...
    const {
      user,
      isAuthenticated
    } = Object(_auth0_auth0_react__WEBPACK_IMPORTED_MODULE_6__["withAuth0"])();

    if (isAuthenticated) {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(NavDropDown, {
        title: user.name,
        id: "user"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Auth_LogoutButton_jsx__WEBPACK_IMPORTED_MODULE_9__["default"], null));
    }
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_auth0_auth0_react__WEBPACK_IMPORTED_MODULE_6__["withAuth0"])(Object(_withToasts_jsx__WEBPACK_IMPORTED_MODULE_7__["default"])(SignInNavItem)));

/***/ })

};
//# sourceMappingURL=server.5de2ac7e8b95504a90ef.hot-update.js.map