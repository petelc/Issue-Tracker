...
async function render(req, res) {
  const activeRoute = !(function webpackMissingModule() { var e = new Error("Cannot find module '../src'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).find(route => Object(react_router_dom__WEBPACK_IMPORTED_MODULE_2__["matchPath"])(req.path, route));
...
//# sourceMappingURL=server.cca2cd69710f54b575cc.hot-update.js.map