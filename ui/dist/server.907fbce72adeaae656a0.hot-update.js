...
app.get('/about', (req, res, next) => {
  !(function webpackMissingModule() { var e = new Error("Cannot find module './render'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(req, res, next);
});
app.get('*', (req, res) => {
...
if (true) {
  module.hot.accept(/*! ./render.jsx */ "./server/render.jsx", function() {  });
}
...
//# sourceMappingURL=server.907fbce72adeaae656a0.hot-update.js.map