...
class IssueEdit extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  static async fetchData(match, showError) {
    ...
    const result = await Object(_graphQLFetch_js__WEBPACK_IMPORTED_MODULE_11__["default"])(query, {
      id
    }, showError);
    return result;
  }
  ...
  constructor(props) {
    super(props);
    const issue = _store_js__WEBPACK_IMPORTED_MODULE_13__["default"].initialData;
    this.state = {
      issue: {},
      invalidFields: {},
...
//# sourceMappingURL=server.5ba87f235146baa95c24.hot-update.js.map