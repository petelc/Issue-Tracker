...
class SignInNavItem extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    ...
    this.signIn = this.signIn.bind(this); // const { isAuthenticated } = withAuth0;
  }
  ...
  render() {
    ...
    const {
      user
    } = this.state; // const { isAuthenticated } = this.isAuthenticated;
...
//# sourceMappingURL=server.aa9def832f9784e10af2.hot-update.js.map