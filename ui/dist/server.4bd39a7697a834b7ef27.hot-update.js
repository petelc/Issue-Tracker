...
class IssueList extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  async deleteIssue(index) {
    ...
    if (data && data.issueDelete) {
      ...
      const undoMessage = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, `Deleted issue ${id}`);
    } else {
      this.loadData();
    }
  }
...
//# sourceMappingURL=server.4bd39a7697a834b7ef27.hot-update.js.map