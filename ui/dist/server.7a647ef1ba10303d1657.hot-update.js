...
class SignInNavItem extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    ...
    this.state = {
      showing: false,
      isAuthenticated: _auth0_auth0_react__WEBPACK_IMPORTED_MODULE_7__["withAuth0"].isAuthenticated,
      user: _auth0_auth0_react__WEBPACK_IMPORTED_MODULE_7__["withAuth0"].user
    };
  ...
  render() {
    ...
    if (isAuthenticated) {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "`Welcome, ", user.name, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Auth_LogoutButton_jsx__WEBPACK_IMPORTED_MODULE_10__["default"], null));
    }
...
//# sourceMappingURL=server.7a647ef1ba10303d1657.hot-update.js.map